...
//    printf("zbest0=%f\n", zbest);
    ...
    zbest=z_H_Sur;
//    printf("zbest1=%f\n", zbest);
//    printf("Mise a jour solution heuristique 1\n");
...
//     printf("z_H_Sur=%f opt_H_Sur_bis=%d\n", z_H_Sur, opt_H_Sur_bis);
    zred=0.0;
...
/*      fflush(NULL);
      ...
      fflush(NULL);*/
       if(zred>zbest){
         zbest=zred;
//         printf("zbest2=%f\n", zbest);
//         printf("Mise a jour solution heuristique 2\n");
         for (i = 0; i < n; i++) {
            xsol[i]=(int)xsdp[i];
//            printf("2: xsol[%d]=%d\n", i, xsol[i]);
         }
...
//      fflush(NULL);
//      printf("Improve: valeur: %f\n\n", zred);
//      fflush(NULL);
       if(zred>zbest){
         zbest=zred;
//         printf("zbest3=%f\n", zbest);
//         printf("Mise a jour solution heuristique 3\n");
...
//       printf("%d: c %d nbobj %d time %.2lf valeur sol heur Hybrid: %d\n", v, c, nbobj, time, zred);
    ...
    if(zred>zbest){
      zbest=zred;
//      printf("zbest4=%f\n", zbest);
//      printf("Mise a jour solution heuristique 4\n");
//      memcpy(xsol, (int)xsdp, MSIZE*sizeof(boolean));
      for (i = 0; i < n; i++) 
        xsol[i]=x[i];
    }
/*    if (z_H_Sur>zred)
...
//             printf("xsdp[%d]=%lf xsdp[%d]=%lf p[%d][%d]=%d\n",i,xsdp[i],j,xsdp[j],i,j,p[i][j]);
      ...
      zred=psumfrac;
//       printf("valeur sol heur SDP: %f psumfrac: %lf\n", zred, psumfrac);
//      fflush(NULL);
//      printf("fix=%d fix1=%d et nred=%d\n",fix,nbfix1,nred);
//      fflush(NULL);
//       for(i=0;i<nred;i++)
...
//             printf("xsdp[%d]=%lf xsdp[%d]=%lf p[%d][%d]=%d\n",tab_indice[i-1],xsdp[tab_indice[i-1]],tab_indice[j-1],xsdp[tab_indice[j-1]],i-2,j-2,psdp[i-2][j-2]);
      ...
      zred=psum;
//      fflush(NULL);
//      printf("valeur sol heur Sur reduit: %f\n", zred);
//      fflush(NULL);
//       zred += zsur;
//       printf("valeur sol heur Greedy: %f\n", z);
//       if (z_H_Pri>zred) zred=z_H_Pri;
//       printf("%d: c %d nbobj %d time %.2lf valeur sol heur Hybrid: %f\n", v, c, nbobj, time, zred);
    }
  }
  if (z_H_Sur>=zred)
  {
//       printf("update zred\n");
  ...
  {
//       printf("update x by xsdp: z_H_Sur=%f et zred= %f\n", z_H_Sur, zred);
    for (i = 0; i < n; i++) 
    {
//       printf("xsdp[%d]=%lf\n", i, xsdp[i]);
//       printf("xsdp[%d]=%d\n", i, (int)xsdp[i]);
